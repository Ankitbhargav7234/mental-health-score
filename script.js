(() => {
  ...
  const API_BASE = "https://mental-health-score-4lmn.onrender.com";
  ...
  resetBtn.addEventListener("click", () => {
    ...
    // Clear custom stress-level selection
    stressHiddenInput.value = "";

    // Remove active state from stress buttons
    segGroup.querySelectorAll(".seg-btn").forEach((btn) => {
